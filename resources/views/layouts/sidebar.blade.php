<aside class="fixed inset-y-0 left-0 w-72 bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl border-r border-rose-100 dark:border-zinc-800 flex flex-col z-50 transition-colors duration-300">
    ...
    <nav class="flex-1 px-6 py-12 space-y-3">
        ...
        <a href="{{ route('dashboard.hardware') }}" class="flex items-center gap-4 px-5 py-4 transition-all rounded-2xl font-bold group {{ $active === 'hardware' ? 'bg-indigo-600 text-white font-black shadow-lg shadow-indigo-200 dark:shadow-none' : 'text-indigo-900/70 dark:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-zinc-800 hover:text-indigo-950 dark:hover:text-zinc-100' }}">
    ...
    <div class="p-8 bg-rose-50/50 dark:bg-zinc-800/40 border-t border-rose-100 dark:border-zinc-800 transition-colors duration-300">
        ...
        <div class="flex items-center gap-4 mb-6">
            <div class="w-12 h-12 rounded-2xl bg-white dark:bg-zinc-800 border border-rose-200 dark:border-zinc-700 flex items-center justify-center font-black text-rose-600 shadow-sm">
            ...
            <div class="overflow-hidden">
                ...
                <span class="inline-block px-2 py-0.5 rounded-lg text-[10px] {{ Auth::user()->isSuperAdmin() ? 'bg-indigo-600' : 'bg-rose-600' }} text-white font-black uppercase tracking-widest mt-1">
