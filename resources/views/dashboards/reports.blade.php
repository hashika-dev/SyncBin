    ...
    <div class="flex min-h-screen bg-gradient-to-br from-rose-50 via-white to-orange-50/50 dark:from-zinc-950 dark:via-zinc-900 dark:to-zinc-950 text-gray-900 dark:text-zinc-100 transition-colors duration-300">
        ...
        <main class="flex-1 ml-72 p-16">
            ...
            <header class="flex items-center justify-between mb-16">
                <div>
                    <h1 class="text-5xl font-black text-rose-950 dark:text-zinc-50 tracking-tighter">Reports & Analytics</h1>
                ...
                <div class="flex gap-4">
                    <button onclick="seedDemoData(this)" class="flex items-center gap-3 px-8 py-4 bg-rose-500 hover:bg-rose-600 text-white rounded-2xl font-black shadow-xl shadow-rose-250 dark:shadow-none hover:-translate-y-1 transition-all active:scale-95">
                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M21.5 2v6h-6M21.34 15.57a10 10 0 1 1-.57-8.38l5.67-5.67"/></svg>
                        Seed Demo Data
                    </button>
                    <a href="{{ route('dashboard.export') }}" target="_blank" class="flex items-center gap-3 px-8 py-4 bg-emerald-500 text-white rounded-2xl font-black shadow-xl shadow-emerald-250 dark:shadow-none hover:bg-emerald-600 hover:-translate-y-1 transition-all active:scale-95">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
                <!-- Total Items -->
                <div class="bg-white/70 dark:bg-zinc-900/70 backdrop-blur-xl border border-white dark:border-zinc-800 rounded-[2.5rem] p-8 shadow-xl dark:shadow-none hover:shadow-rose-200/20 transition-all duration-300">
                    <div class="flex items-center justify-between mb-6">
                        <span class="text-xs font-black uppercase tracking-widest text-rose-350 dark:text-zinc-500">Total Items</span>
                    ...
                    <span class="block text-4xl font-black text-rose-950 dark:text-zinc-50 tracking-tight">{{ $totalItemsCount }}</span>
                    <span class="block text-xs font-bold text-rose-500/70 dark:text-rose-400/70 mt-2">Classified waste items</span>
                </div>

                <!-- Recycling Rate -->
                <div class="bg-white/70 dark:bg-zinc-900/70 backdrop-blur-xl border border-white dark:border-zinc-800 rounded-[2.5rem] p-8 shadow-xl dark:shadow-none hover:shadow-rose-200/20 transition-all duration-300">
                    <div class="flex items-center justify-between mb-6">
                        <span class="text-xs font-black uppercase tracking-widest text-rose-350 dark:text-zinc-500">Recycle Rate</span>
                    ...
                    <span class="block text-4xl font-black text-emerald-600 dark:text-emerald-400 tracking-tight">{{ $recyclingRate }}%</span>
                    <span class="block text-xs font-bold text-emerald-500/70 dark:text-emerald-400/60 mt-2">Eco-friendly ratio</span>
                </div>

                <!-- Total Weight -->
                <div class="bg-white/70 dark:bg-zinc-900/70 backdrop-blur-xl border border-white dark:border-zinc-800 rounded-[2.5rem] p-8 shadow-xl dark:shadow-none hover:shadow-rose-200/20 transition-all duration-300">
                    <div class="flex items-center justify-between mb-6">
                        <span class="text-xs font-black uppercase tracking-widest text-rose-350 dark:text-zinc-500">Total Mass</span>
                    ...
                    <span class="block text-4xl font-black text-sky-600 dark:text-sky-400 tracking-tight">{{ $totalWeightKg }} kg</span>
                    <span class="block text-xs font-bold text-sky-500/70 dark:text-sky-400/60 mt-2">Combined waste weight</span>
                </div>

                <!-- Peak Bin -->
                <div class="bg-white/70 dark:bg-zinc-900/70 backdrop-blur-xl border border-white dark:border-zinc-800 rounded-[2.5rem] p-8 shadow-xl dark:shadow-none hover:shadow-rose-200/20 transition-all duration-300">
                    <div class="flex items-center justify-between mb-6">
                        <span class="text-xs font-black uppercase tracking-widest text-rose-350 dark:text-zinc-500">Peak Bin</span>
                    ...
                    <span class="block text-3xl font-black text-orange-500 dark:text-orange-400 tracking-tight truncate uppercase">{{ $mostActiveBin ? $mostActiveBin->name : 'None' }}</span>
                    <span class="block text-xs font-bold text-orange-500/70 dark:text-orange-400/60 mt-2">Most active classification</span>
                </div>
            </div>

            <!-- Activity Trends Line Chart Card -->
            <div class="bg-white/70 dark:bg-zinc-900/70 backdrop-blur-xl border border-white dark:border-zinc-800 rounded-[3rem] p-12 shadow-xl dark:shadow-none hover:shadow-rose-200/20 transition-all duration-300 mb-12">
                <div class="mb-8">
                    <h3 class="text-2xl font-black text-rose-950 dark:text-zinc-100 tracking-tight">Activity Trends</h3>
                    <p class="text-[10px] font-black text-rose-300 dark:text-rose-400 uppercase tracking-[0.3em] mt-2">Waste items segregated over the last 7 days</p>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-12 pb-24">
                <!-- Column 1 & 2: Volume Comparison Chart -->
                <div class="md:col-span-2 bg-white/70 dark:bg-zinc-900/70 backdrop-blur-xl border border-white dark:border-zinc-800 rounded-[3rem] p-12 shadow-xl dark:shadow-none hover:shadow-rose-200/20 transition-all duration-300 flex flex-col">
                    <div class="mb-10">
                        <h3 class="text-2xl font-black text-rose-950 dark:text-zinc-100 tracking-tight">Classification Distribution</h3>
                        <p class="text-[10px] font-black text-rose-300 dark:text-rose-400 uppercase tracking-[0.3em] mt-2">Volume and share percentage per category</p>
                    </div>
                            ...
                            <div class="space-y-3">
                                <div class="flex justify-between items-center text-sm">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <span class="font-black text-rose-950 dark:text-zinc-100 uppercase tracking-widest text-[10px]">{{ $bin->name }}</span>
                                    </div>
                ...
                <div class="bg-white/70 dark:bg-zinc-900/70 backdrop-blur-xl border border-white dark:border-zinc-800 rounded-[3rem] p-12 shadow-xl dark:shadow-none hover:shadow-rose-200/20 transition-all duration-300 flex flex-col items-center text-center justify-between">
                    <div>
                        <h3 class="text-2xl font-black text-rose-950 dark:text-zinc-100 tracking-tight">Eco Target</h3>
                        <p class="text-[10px] font-black text-rose-300 dark:text-rose-400 uppercase tracking-[0.3em] mt-2">Segregation Target Rate</p>
                    </div>

                    <!-- Circular Progress Meter -->
                    <div class="relative w-44 h-44 my-8 flex items-center justify-center">
                        ...
                        <div class="absolute flex flex-col items-center justify-center">
                            <span class="text-3xl font-black text-emerald-600 dark:text-emerald-400">{{ $recyclingRate }}%</span>
                    ...
                    <div>
                        ...
                        <p class="text-xs text-rose-500/70 dark:text-rose-400/60 mt-4 leading-relaxed max-w-[200px]">
