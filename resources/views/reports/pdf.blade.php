...
<head>
    <meta charset="utf-8">
    <title>SyncBin System Status Report</title>
    <style>
        body {
...
<body>
    <div class="header">
        <table class="meta-table">
            <tr>
                <td>
                    <h1 class="header-title">SyncBin</h1>
                ...
                <td class="meta-right">
                    ...
                    <strong>Environment:</strong> WasteSync Live Hub
                </td>
            </tr>
        </table>
    </div>
    ...
    <div class="footer">
        <p>SyncBin Capstone Exhibition • Design and Hardware Prototype segregation reporting system</p>
