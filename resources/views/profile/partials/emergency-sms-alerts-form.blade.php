<section x-data="{
    ...
    <header class="flex items-center justify-between pb-6 border-b border-rose-100 dark:border-zinc-800">
        <div>
            <div class="flex items-center gap-3 mb-2">
                ...
                <span class="text-xs font-bold text-rose-600 dark:text-rose-400">Emergency Dispatch</span>
            </div>
            <h2 class="text-2xl font-black text-rose-950 dark:text-zinc-50 tracking-tight">Emergency SMS Alerts</h2>
            <p class="text-sm font-bold text-rose-900/60 dark:text-zinc-400 mt-1">
                Configure real-time SMS emergency dispatch contacts when any bin reaches capacity threshold.
            </p>
        </div>
    </header>
    ...
    <form @submit.prevent="addContact()" class="pt-6 border-t border-rose-100 dark:border-zinc-800 space-y-4">
        ...
        <button type="submit" class="w-full sm:w-auto px-8 py-3.5 bg-rose-500 hover:bg-rose-600 text-white rounded-xl font-black text-xs uppercase tracking-wider shadow-lg shadow-rose-200 dark:shadow-none hover:-translate-y-0.5 active:translate-y-0 transition-all flex items-center justify-center gap-2">
